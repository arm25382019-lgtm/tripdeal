...
export const AIRPORTS: AirportOption[] = [
  // Thailand
  { code: 'BKK', city: 'กรุงเทพ', country: 'ไทย', label: 'กรุงเทพ (ทุกสนามบิน) · BKK', region: 'Thailand' },
  ...
  { code: 'CEI', city: 'เชียงราย', country: 'ไทย', label: 'เชียงราย · CEI', region: 'Thailand' },
  ...
  { code: 'USM', city: 'เกาะสมุย', country: 'ไทย', label: 'เกาะสมุย · USM', region: 'Thailand' },
  ...
  { code: 'UTP', city: 'พัทยา / ระยอง', country: 'ไทย', label: 'อู่ตะเภา · UTP', region: 'Thailand' },
